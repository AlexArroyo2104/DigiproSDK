...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.public_header_files = 'DIGIPROSDK.framework/Headers/*.h', 'DIGIPROSDKSO.framework/Headers/*.h', 'DIGIPROSDKATO.framework/Headers/*.h'
  s.source_files = 'DIGIPROSDK.framework/Headers/*.h', 'DIGIPROSDKSO.framework/Headers/*.h', 'DIGIPROSDKATO.framework/Headers/*.h'
  s.vendored_frameworks = 'DIGIPROSDK.framework', 'DIGIPROSDKSO.framework', 'DIGIPROSDKATO.framework'
