...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.public_header_files = 'DIGIPROSDK.framework/Headers/*.h', 'DIGIPROSDKUI.framework/Headers/*.h', 'DIGIPROSDKBNL.framework/Headers/*.h', 'DIGIPROSDKSO.framework/Headers/*.h','DIGIPROSDKFO.framework/Headers/*.h','DIGIPROSDKVO.framework/Headers/*.h'
  s.source_files = 'DIGIPROSDK.framework/Headers/*.h', 'DIGIPROSDKUI.framework/Headers/*.h', 'DIGIPROSDKBNL.framework/Headers/*.h',  'DIGIPROSDKSO.framework/Headers/*.h', 'DIGIPROSDKFO.framework/Headers/*.h','DIGIPROSDKVO.framework/Headers/*.h'
  s.vendored_frameworks = 'DIGIPROSDK.framework', 'DIGIPROSDKUI.framework', 'DIGIPROSDKBNL.framework', 'DIGIPROSDKSO.framework', 'DIGIPROSDKFO.framework', 'DIGIPROSDKVO.framework'
